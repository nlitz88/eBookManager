angular.module("mainApp")
    .controller('addBooksController', ["$scope", "crudService", function($scope, crudService) {
        ...
        function submitFields() {
            ...
            for(field in self.fields) {
                let fieldPromise = crudService.dbInsertBooks(self.fields[field]);
                fieldPromise.then(function(affected){
                    // FOR SOME REASON, INSERTING A STRING INTO AN INTEGER COLUMN DOESN'T CAUSE AN ERROR!!!!
                    console.log(affected);
                    // then display books, using filterText just in case there is filter text in place
                });
            }
